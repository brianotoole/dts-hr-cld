            ...
            <div class="hero__text">
              ...
              <?php if (get_field('hero_button_type') == 'video') : ?>
                <div class="hero__button">
                  ...
                  <a href="//fast.wistia.net/embed/iframe/yzhn558bcf?popover=true" class="btn btn--primary wistia-popover[height=388,playerColor=7b796a,width=640]">Watch Video</a>
