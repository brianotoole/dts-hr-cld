 ...
 <div class="container">
     ...
     <div class="row between-xs">
       <div class="col-sm-3">
         <ul class="footer__top-menu">
           ...
           <li><a href=" echo home_url(); ?>/team">Team</a></li>
           <li><a href=" echo home_url(); ?>/about">About</a></li>
           <li><a href=" echo home_url(); ?>/resources/?type=blog">Blog</a></li>
       ...
       <div class="col-sm-3">
         <ul class="footer__top-menu">
           ...
           <li><a href=" echo home_url(); ?>/solutions">Overview</a></li>
           <li><a href=" echo home_url(); ?>/solution/position-control">Position Control</a></li>
           <li><a href=" echo home_url(); ?>/solution/recruiting">Recruiting</a></li>
           <li><a href=" echo home_url(); ?>/solution/time-and-attendance">Time &amp; Attendance</a></li>
           <li><a href=" echo home_url(); ?>/solution-benefits-administration">Benefits Administration</a></li>
           <li><a href=" echo home_url(); ?>/payroll">Payroll</a></li>
           <li><a href=" echo home_url(); ?>/talent-management">Talent Management</a></li>
           <li><a href=" echo home_url(); ?>/workforce-analytics">Workforce Analytics</a></li>
         </ul>
       </div>
       <div class="col-sm-3">
         <ul class="footer__top-menu">
   ...
   <div class="footer__bottom">
     ...
     <div class="footer__bottom-menu">
       <ul>
         <li><a href="https://datishrcloud.e3applicants.com/" target="_blank">Careers</a></li>
         <li><a href="http://go.datis.com/ContactUs" target="_blank">Contact</a></li>
